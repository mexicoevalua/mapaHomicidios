# Crear mapa interactivo con la tasa de averiguaciones previas para el total de 
# homicidios
...
n  <- gsub("Total","TOT",n)
names(tasas_ave)  <- n
write.csv(tasas_ave, "data/tasas_ave_hom_tot.csv", fileEncoding="utf8")
...
require(foreign)
shp  <- read.dbf("shapefiles//tasas_ave_hom_tot.dbf", as.is=T)
...
write.dbf(shp,"shapefiles//tasas_ave_hom_tot.dbf")
